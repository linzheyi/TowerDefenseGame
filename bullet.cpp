...
Bullet::Bullet(QPoint startPos,QPoint targetPos,int damage,Enemy * targetEnemy,WoodMap * game,QString path):
    m_startPos(startPos),
...
{
    if(m_game->getEnemyList().indexOf(m_targetEnemy)!=-1)//如果敌人列表中，有子弹击中的这个敌人，该敌人受到相应的伤害
    {
